...
// ----------------------------------------------------------------------
// 5. PRINT VIEW (แก้ไขให้โลโก้แสดงผลถาวร ทั้งบนเว็บ มือถือ และ PDF)
// ----------------------------------------------------------------------
const PrintView = ({ req, onClose }) => {
  ...
  // โลโก้บริษัทในรูปแบบ Base64 (ตัดปัญหา CORS ถาวร)
  const LOGO_BASE64 = "data:image/png;base64,";
        ...
        <div id="print-area" className="p-6 sm:p-8 lg:p-12 overflow-y-auto bg-white text-black font-sans text-xs">
          <div className="flex justify-between items-center border-b-2 border-black pb-4 mb-6">
            <div className="flex items-center gap-4">
              {/* เปลี่ยนไปใช้ Base64 สดๆ เพื่อตัดปัญหา CORS ข้ามภพข้ามชาติ */}
              <img id="pdf-logo" src={LOGO_BASE64} alt="Kasetphand Logo" className="h-12 w-auto" />
              <div>
